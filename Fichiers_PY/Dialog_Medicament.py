...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.comboBoxEffet.addItem("")
        self.comboBoxEffet.addItem("")
        self.labelErreurNomCommercial = QtWidgets.QLabel(Dialog)
        self.labelErreurNomCommercial.setGeometry(QtCore.QRect(20, 350, 271, 16))
        self.labelErreurNomCommercial.setText("")
        self.labelErreurNomCommercial.setObjectName("labelErreurNomCommercial")
        self.labelErreurPrix = QtWidgets.QLabel(Dialog)
        self.labelErreurPrix.setGeometry(QtCore.QRect(20, 470, 271, 16))
        self.labelErreurPrix.setText("")
        self.labelErreurPrix.setObjectName("labelErreurPrix")
        self.labelErreurDuree = QtWidgets.QLabel(Dialog)
        self.labelErreurDuree.setGeometry(QtCore.QRect(660, 120, 271, 16))
        self.labelErreurDuree.setText("")
        self.labelErreurDuree.setObjectName("labelErreurDuree")
        self.labelErreurCode = QtWidgets.QLabel(Dialog)
        self.labelErreurCode.setGeometry(QtCore.QRect(20, 110, 271, 16))
        self.labelErreurCode.setText("")
        self.labelErreurCode.setObjectName("labelErreurCode")
        self.labelAjoutMedicament = QtWidgets.QLabel(Dialog)
        self.labelAjoutMedicament.setGeometry(QtCore.QRect(20, 550, 301, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        self.labelAjoutMedicament.setFont(font)
        self.labelAjoutMedicament.setStyleSheet("color: rgb(85, 255, 0);")
        self.labelAjoutMedicament.setObjectName("labelAjoutMedicament")
        self.labelAjoutErreur = QtWidgets.QLabel(Dialog)
        self.labelAjoutErreur.setGeometry(QtCore.QRect(20, 550, 301, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        self.labelAjoutErreur.setFont(font)
        self.labelAjoutErreur.setStyleSheet("color: rgb(255, 0, 0);")
        self.labelAjoutErreur.setObjectName("labelAjoutErreur")
        self.labelErreurNomChimique = QtWidgets.QLabel(Dialog)
        self.labelErreurNomChimique.setGeometry(QtCore.QRect(20, 230, 271, 16))
        self.labelErreurNomChimique.setText("")
        self.labelErreurNomChimique.setObjectName("labelErreurNomChimique")
        self.labelErreurPrise = QtWidgets.QLabel(Dialog)
        self.labelErreurPrise.setGeometry(QtCore.QRect(660, 240, 271, 16))
        self.labelErreurPrise.setText("")
        self.labelErreurPrise.setObjectName("labelErreurPrise")
        self.labelExistePas = QtWidgets.QLabel(Dialog)
        self.labelExistePas.setGeometry(QtCore.QRect(20, 550, 301, 31))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.labelAjoutMedicament.setText(_translate("Dialog", "Le médicament a été ajouté !"))
        self.labelAjoutErreur.setText(_translate("Dialog", "Ce médicament existe déjà !"))
        self.labelExistePas.setText(_translate("Dialog", "Ce médicament n\'existe pas !"))
